            ...
            <div className="py-6">
                <div className="mx-auto max-w-2xl px-4 sm:px-6 md:px-8">
                    ...
                    <div className="mb-8">
                        ...
                        <h1 className="text-3xl font-bold tracking-tight text-gray-900 dark:text-white">Create Expense</h1>
                        <p className="mt-2 text-base text-gray-600 dark:text-gray-400">Add a new expense to your tracker</p>
                    </div>
