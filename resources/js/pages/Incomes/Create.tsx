            ...
            <div className="py-6">
                <div className="mx-auto max-w-2xl px-4 sm:px-6 md:px-8">
                    <div className="mb-8">
                        ...
                        <h1 className="text-3xl font-bold tracking-tight text-gray-900 dark:text-white">Create Income</h1>
                    ...
                    <form onSubmit={handleSubmit} className="rounded-lg bg-white dark:bg-white/5 border border-gray-200 dark:border-gray-700 p-6 shadow-sm">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="flex gap-4 pt-4">
                                <button type="submit" disabled={processing} className="flex-1 rounded-lg bg-emerald-600 px-4 py-2 text-sm font-semibold text-white">{processing ? 'Saving...' : 'Save Income'}</button>
